package com.chengbrian.EasyDataBase;
...
import com.chengbrian.EasyDataBase.Command.ImainCommandSystem;
...
public class main extends JavaPlugin{
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    	return Command(sender,command,label,args,main.class.getClassLoader(),"com.chengbrian." + DataBase.pluginName + ".Command");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
    	return onTabComplete(sender,cmd,label,args,main.class.getClassLoader(),"com.chengbrian." + DataBase.pluginName + ".Command");
    }
